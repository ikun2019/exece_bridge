class Customer < ApplicationRecord
  ...
  VALIS_EISU_REGEX = /\A[a-zA-Z0-9]+\z/
  with_options presence: true do
    ...
    validates :password, format: {with: VALIS_EISU_REGEX, message: "半角英数字を入力してください"}
    validates :password_confirmation, format: {with: VALIS_EISU_REGEX, message: "半角英数字を入力してください"}
  end
